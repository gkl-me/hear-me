...
const verify = (req,res)=> {
    try {
        ...
        res.render('user/verify',{title:'OTP verify',email:req.session.email,otpTime:req.session.optTime})
...
const verifyPost = async (req,res)=>{
    try {
        ...
        if(req.body.otp === req.session.otp){
            ...
            await userSchema.insertMany(details).then(()=>{
...
module.exports = {
    user,signup,signgupPost,verify,verifyPost,otpResend,login,loginPost,logout
}
